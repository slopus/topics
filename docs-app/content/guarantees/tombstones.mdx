...
description: How topics makes involuntary loss explicit — the dual watermark, when a tombstone fires, its shape and reason values, and why deleted or node-filtered gaps stay silent.
---
